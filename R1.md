...
Having prepared gulpfile for the project, I dived into building the blog. I've figured out different concepts as permalinks, categories, and prepared the main parts of the blog's structure. The most difficult part was to make pages for each category of posts.
Also, I figured out how to customize bootstrap source files with Sass, and learned about !default Sass keyword. 
